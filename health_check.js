...
export function setup() {
  // const addVehicleUrl = "https://api.gps-tracker.store/api/vehicle";
  ...
  // );
  // 1. 토큰 발급 요청
  const tokenUrl = "https://api.gps-tracker.store/api/emulator/token";
  ...
  // const onUrl = `https://api.gps-tracker.store/api/emulator/on`;
...
export default function (data) {
  const url = `https://api.gps-tracker.store/api/emulator/gps`;
  const params = {
    headers: {
      "Content-Type": "application/json",
